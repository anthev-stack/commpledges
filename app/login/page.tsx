...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // First check if user exists and account type
      ...
      if (checkResponse.ok) {
        ...
        if (accountType === 'discord') {
          setError("It looks like you signed up with Discord. Please use the 'Continue with Discord' button below to log in.")
          setLoading(false)
          return
        }
      }
      ...
      if (result?.error) {
        setError("Invalid email or password. If you signed up with Discord, please use the 'Continue with Discord' button below.")
      } else {
